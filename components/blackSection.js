...
const Feature = ({ title, text, icon }) => {
  return (
    <Flex
      justify={"left"}
      w={{ base: "22.25rem", md: "19.3125rem" }}
      h="17.4375rem"
      borderRadius={"0.875rem"}
      border={" 2px solid #FFF"}
      background="#000"
      boxShadow="4px 12px 28px 2px rgba(143, 143, 143, 0.12)"
    ...
    >
      ...
      <Box>
        <Text
          ...
          fontSize={{ base: "1.01rem", md: "1.25rem" }}
          mb={{ base: "0.91rem", md: "0.88rem" }}
        >
          {title}
        </Text>
        <Text
          ...
          lineHeight={{ base: "1.37rem", md: "1.15863rem" }}
        >
          {text}
        </Text>
      </Box>
  ...
  return (
    ...
    >
      <Container maxW="100%" centerContent>
        <Box
          maxW={{ base: "22.62rem", md: "62.375rem" }}
          mt={{ base: "3rem", md: "6.62rem" }}
          mb={{ base: "2.68rem", md: "5rem" }}
          align="center"
        >
          <Text
            ...
            mt={{ base: "1rem" }}
          >
            Our exclusive services to help you make and receive payments
          </Text>
          <Text
            ...
            mt={{ base: "1rem" }}
          >
            Take control of your finances and optimize your money flow like
            never before.
          </Text>
        </Box>
        <Flex flexDir={["column", "row"]} gap={"5rem"}>
          <VStack justify={"center"} align="center" spacing="3.62rem">
            <Feature
              ...
              text="Intuitive features so you can effortlessly manage your financial transactions"
            />
            <Feature
              icon={qrScan}
              title="Monapp QR Code Card"
              text="Shop online and offline with our QR code card. Free delivery and zero maintenance fee"
            />
          </VStack>
          <Flex flexDir={{ base: "column-reverse", md: "row" }} gap="5rem">
            ...
            <VStack justify={"center"} align="center" spacing="3.62rem">
              <Feature
                icon={exchangeIcon}
                title="Payment Links"
                text="Use Payment Links to collect payments swiftly. Share the link with your customers and they can pay through multiple channels."
              />
              <Feature
                icon={careIcon}
                title="First-Level Technical Support"
                text="No queue. Resolve your queries and concerns swiftly on the app with our one-on-one first-level support."
              />
            </VStack>
          </Flex>
        </Flex>
